...
import { MTableButton, PageButton } from "./shared/MTableButton";
import { classNames } from "./shared/MTableUtils";
import { SortIcon, SortUpIcon, SortDownIcon } from "./shared/MTableIcons";
    ...
    <>
      ...
      <div className="flex items-center justify-between py-3">
        <div className="flex flex-1 justify-between sm:hidden">
          ...
          <MTableButton onClick={() => nextPage()} disabled={!canNextPage}>
            Next
          </MTableButton>
        </div>
